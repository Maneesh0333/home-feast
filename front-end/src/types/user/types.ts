...
export type subscriptionSchemaType = yup.InferType<typeof subscriptionSchema>;
...
export type MealType = "Veg" | "Non-Veg" | "Both";

export type PlanType = "daily"| "weekly"| "monthly" | "All";
